...
ALTER DEFAULT PRIVILEGES IN SCHEMA storeuser GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO responsable;
ALTER DEFAULT PRIVILEGES IN SCHEMA storeuser     GRANT ALL PRIVILEGES ON TABLES TO adm;
ALTER DEFAULT PRIVILEGES IN SCHEMA storeuser GRANT SELECT, INSERT, UPDATE ON TABLES TO agent;
